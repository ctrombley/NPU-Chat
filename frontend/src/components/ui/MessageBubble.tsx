  ...
  'block m-2.5 p-2.5 text-tn-fg bg-transparent rounded-lg',
  {
    variants: {
      variant: {
        ...
        received:
          'bg-message-received w-4/5 shadow-lg border-r-2 border-tn-magenta rounded-tr-3xl rounded-br-3xl pt-1.5 pr-20 mr-12 mb-5 word-wrap break-words text-left',
      },
    },
  }
);
